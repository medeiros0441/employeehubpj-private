...
<div  class=" mx-auto    card-body row  p-3 container" >
            ...
            <itemtemplate>
                <asp:LinkButton CssClass=" text-center rounded-3 mx-sm-3 mx-auto    col-11   text-decoration-none my-2        col-md-6 col-lg-4 " runat="server" OnClick="Btn_sessao_Click" ID="LinkButton1" class="btn btn-secondary"  CommandArgument='<%# DataBinder.Eval(Container.DataItem, "IdCliente") %>' >
