...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
        ...
        .custom-shape-divider-top-1694981738 {
    position: relative;
    top: 0;
    left: 0;
    margin-top: -3px;
...
.custom-shape-divider-top-1694981738 svg {
    position: relative;
    display: block;
...
.custom-shape-divider-top-1694981738 .shape-fill {
    fill: #212529;
}
    </style>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container-fluid p-4 " style="background:var(--bs-dark);margin-top:-9px">
        <div class="row featurette container mx-auto p-2 text-light">
            <div class=" clearfix">
       ...
       Nosso compromisso é tornar a jornada de emprego mais eficiente e eficaz, não importa qual seja o seu perfil profissional ou necessidades de contratação.
                ...
                <div class="float-md-end mb-3 ms-md-3 ">
<img src="../imagens/objetos-empresa/logo-whiter.png"   alt="..." class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="200" height="200">
    </div>
   <h1 class="font-monospace fs-4 fw-bold mnA offcanvas-title" style="color: var(--laranja);">Nossa Missão</h1>

   <p class="font-monospace small font-weight-light"  style=" font-size:15px">
       Nossa missão é proporcionar um espaço inclusivo e dinâmico, onde profissionais PJ podem encontrar oportunidades de emprego em várias modalidades, incluindo empregos com carteira assinada (CLT), trabalhos freelance, contratos temporários e muito mais.
...
<img src="../imagens/objetos-empresa/samuel.jpg"  class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto object-fit-fill   rounded shadow-lg      " width="300" height="300">

      </div>
    </div>
    </div>
                <div class="custom-shape-divider-top-1694981738 ">
    <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 1200 120" preserveAspectRatio="none">
        <path d="M985.66,92.83C906.67,72,823.78,31,743.84,14.19c-82.26-17.34-168.06-16.33-250.45.39-57.84,11.73-114,31.07-172,41.86A600.21,600.21,0,0,1,0,27.35V120H1200V95.8C1132.19,118.92,1055.71,111.31,985.66,92.83Z" class="shape-fill"></path>
    </svg>
</div>

        <div class="row  p-sm-4 container mx-auto">
            
                    <div class=" py-5">
                        <svg class="bi me-2   figure-img" color="var(--laranja)" width="25" height="25" fill="currentColor">
                            <use href="../imagens/icones/bootstrap-icons.svg#envelope"></use></svg>
                        <label class="menu">
                            <a style="color: black;" class=" text-uppercase font-monospace card-title" id="#Contato">E-mail</a>
                        </label>
                        <hr />
                        ...
                        <div class="form-floating mb-3">
                            <asp:TextBox ID="txtTelefone" CssClass="form-control phone" MaxLength="15" runat="server" placeholder="telefone" />
                            <asp:Label runat="server" Text="Telefone" AssociatedControlID="txtTelefone" CssClass="form-label text-secondary" />
                            <asp:RequiredFieldValidator ID="rfvTelefone" runat="server" ControlToValidate="txtTelefone" Display="Dynamic" ErrorMessage="Campo Telefone é obrigatório"  ForeColor="red"   CssClass="ms-2 small text-uppercase font-monospace" style=" font-size:15px" />
                        </div>
                        <div class="form-floating mb-3">
                            <asp:TextBox ID="txtMensagem" CssClass="form-control" runat="server" Height="200px" MaxLength="1000" TextMode="MultiLine" AutoCompleteType="Disabled" placeholder="mensagem" />
                            <asp:Label runat="server" Text="Mensagem" AssociatedControlID="txtMensagem" CssClass="form-label text-secondary" for="txtMensagem" />
                            <asp:RequiredFieldValidator ID="rfvMensagem" runat="server" ControlToValidate="txtMensagem" ErrorMessage="Campo Mensagem é obrigatório" Display="Dynamic"   ForeColor="red"  CssClass="ms-2 small text-uppercase font-monospace" style=" font-size:15px" />
                        </div>

                        <asp:Button ID="BtnEnviar" runat="server" Text="Enviar" CssClass="btn  btn-outline-customer btn-md float-start " OnClick="BtnEnviar_Click" />
                        <asp:Button ID="Btncancelar" runat="server" Text="limpar" CssClass="btn btn-outline-secondary btn-sm float-end mx-2  my-1  " CausesValidation="false" OnClick="Btncancelar_Click" />
                    </div>
        </div>
