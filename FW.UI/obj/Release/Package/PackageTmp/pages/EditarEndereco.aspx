<%@ Page Title="" Language="C#" MasterPageFile="../Default.Master" AutoEventWireup="true" CodeBehind="EditarEndereco.aspx.cs" Inherits="FW.UI.pages.EditarEndereco" %>
                                ...
                                <asp:Panel runat="server" DefaultButton="btnSalvarEndereco">
                                    <div class="row g-2">
                                        ...
                                        <div class="col-sm-5 col-md-4 form-floating">
                                            <asp:TextBox runat="server" CssClass="form-control txtUF "   ID="txtUF"       TabIndex="3" /> 
                                        ...
                                        <asp:Button runat="server" CssClass=" btn mx-auto px-auto col-auto py-2 w-50    btn-outline-customer rounded-2"  TabIndex="8" ValidationGroup="Validacaoendereco" ID="btnSalvarEndereco" OnClick="BtnSalvarEndereco_Click" CausesValidation="true" Text="Salvar" EnableViewState="False"  ></asp:Button>
                                    </div>
                                </asp:Panel>
                            </div>
                        </div>
