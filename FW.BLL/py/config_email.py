...
def enviar_email(destinatario, assunto, NomeCliente, TextIntroducao, TextContainer2 = "", TextContainer3 = "", btn_vermais = False):
    # Lista de contas de e-mail que você deseja alternar em caso de problemas
    contas_email = [
        {"username": "medeiros0441@gmail.com", "password": "lsudyhkesbwgbrez"},
    ...
    for conta in contas_email:
        ...
        html_body = gerar_html_email.corpo_email(NomeCliente, TextIntroducao, TextContainer2, TextContainer3, btn_vermais)
        ...
        try:
            ...
            if error_code == 550 and b"Daily user sending quota exceeded" in error_message:
                print("Limite diário de envio de e-mails atingido. Alternando para outra conta.")
            else:
